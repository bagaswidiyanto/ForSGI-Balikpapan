       ...
       <div class="container-fluid footer">
           <img src="<?= base_url(); ?>assets/imagenew/bg-footer.png" class="img-fluid bg" alt="">
           <div class="container pt-5 px-lg-5">
               <div class="row">
                   <div class="col-lg-6 mt-4" data-aos="fade-up" data-aos="fade-up" data-aos-duration="2000">
                       <h3>OUR LOCATION</h3>
                       <?= $website->address; ?>

                       <h3 class="mt-4">Contact Information</h3>
                       <a class="btn-footer-info" href="https://wa.wizard.id/611e7c" target="_blank"
                           title="Klik untuk bertanya lebih detail"><i class="fa fa-whatsapp"></i> Info Lebih Lanjut</a>

                       <div class="btn-footer-mail mt-5">
                           <a href=""><i class="fa fa-envelope-o" aria-hidden="true"></i>
                               <span><?= $website->email; ?></span></a>
                       </div>
                       ...
                       <div class="btn-footer-link mt-4">
                           <a href="">www.forsgibpn.com</a>
                       </div>
                   </div>
                   <div class="col-lg-6 mt-4" data-aos="fade-up" data-aos="fade-up" data-aos-duration="2000">
                       <?= $website->map; ?>
           ...
           <div id="whatsapp-chat-popup" class="animate__animated animate__bounceOutDown"
               ...
               <div id="list-chat-section" class="list-chat-section animate__animated animate__fadeIn"
                   ...
                   <div class="header-section"
                       style="background: linear-gradient(180deg, #FDE400 -14.6%, rgba(0, 153, 67, 0.73) 93.43%, #999300 100%);">
                       ...
                       <div class="header-avatar-section">
                           ...
                           <div class="avatar">
                               <img class="avatar"
                                   ...
                                   src="https://admin103.forsgibpn.com/upload/wa_image/<?= $sec1->image; ?>">
                           </div>
                           <? } ?>
                       </div>
                   ...
                   <div class="chat-section">
                       ...
                       <div class="cs-section" onclick="chatCustomer(<?= $sec2->id; ?>);">
                           <div class="avatar">
                               <img class="avatar"
                                   src="https://admin103.forsgibpn.com/upload/wa_image/<?= $sec2->image; ?>">
                           </div>
                           <div class="profile">
                   ...
                   <div class="header-section"
                       ...
                       <div class="header-avatar-section">
                           <div class="avatar">
                               <img class="avatar"
                                   style="position: relative; display: inline-block; vertical-align: middle; height: 60px; width: 60px; border-radius: 60px;"
                                   src="https://admin103.forsgibpn.com/upload/wa_image/<?= $sec3->image; ?>">
                           </div>
                       </div>
                   ...
                   <div class="inside-chat-section">
                       <div class="chat">
                           <div class="inside-chat">
                               <span>Halo saya <?= ucwords(strtolower($sec3->nama)); ?>, dari FORSGI Balikpapan.</span>
                           </div>
                           <div class="time">
